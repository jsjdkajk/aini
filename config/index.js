export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxcfe7c02207b16c6f",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "0b3d176f04f4336a16b36d27721a4476",
   ...
   */
  USERS: [oWOK75zmB4rsW7FUj467L9higTao,oWOK750b48ogpIbBO-sjc9WzBb6Y
    {
      // 想要发送的人的名字
      name: "老婆0",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "jVze5op_kgSXz76td2Qf9aOmxkauI9ywRt10Qqi1DoM",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "三明",
